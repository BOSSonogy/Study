...
pears = apples + 5
plums = apples - 2
print(f'В садку посадили {apples} яблуні, {pears} груш та {plums} сливи')
...
temp_to_dinner = 5
temp_after_dinner = temp_to_dinner - 10
temp_at_evening = temp_after_dinner + 4
print(f'Температура повітря ввечері {temp_at_evening} градусів')
